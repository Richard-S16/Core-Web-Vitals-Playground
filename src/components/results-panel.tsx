...
type Tab = "overview" | "metrics" | "bundle" | "suggestions";
...
export function ResultsPanel({
  ...
  const suggestions = useMemo(
    () => generateSuggestions(result.metrics, rawResponse),
    [result.metrics, rawResponse]
  );

  const bundleData = useMemo(
    () => (rawResponse ? parseBundleData(rawResponse) : null),
    [rawResponse]
  );
